    ...
    <SmoothScroll>
      <main className="min-h-screen bg-[#ecebeb] text-[#161310]">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-10 flex items-center gap-4">
                <button
                  onClick={buy}
                  disabled={loading}
                  className="border whitespace-nowrap text-nowrap border-black/50 px-6 py-3 text-sm text-black/90 hover:bg-black hover:text-white transition disabled:opacity-50"
                >
                ...
                <div className="p-6 lg:p-8">
                  ...
                  <div className="mt-8 border-t border-black/15 pt-6 flex items-center justify-between">
                    ...
                    <button
                      onClick={buy}
                      disabled={loading}
                      className="border whitespace-nowrap border-black/50 px-6 py-3 text-sm text-black/90 hover:bg-black hover:text-white transition disabled:opacity-50"
                    >
                      {loading ? "Redirecting…" : "Buy — €79"}
                    </button>
                  </div>
        ...
        <footer className="px-6 pb-10">
          <div className="mx-auto max-w-6xl border-t border-black/15 pt-6 text-xs text-black/60 flex justify-between">
            <span>© {new Date().getFullYear()} Lamp House</span>
